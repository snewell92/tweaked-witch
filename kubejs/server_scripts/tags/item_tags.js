ServerEvents.tags('item', event => {
    ...
    // Walnuts
    event.add('forge:nuts',
        'caupona:walnut'
    )
    event.add('forge:nuts/walnut',
        'caupona:walnut'
    )
    event.add('caupona:walnut',
        'ecologics:walnut'
    )
    ...
    // BYG Sand Tags
    event.add('c:sand/purple',
        'byg:purple_sand'
    )
    event.add('c:sand/pink',
        'byg:pink_sand'
    )
    event.add('c:sand/blue',
        'byg:blue_sand'
    )
    event.add('c:sand/white',
        'byg:white_sand'
    )
    event.add('c:sand/black',
        'byg:black_sand'
    )

    // Duck Tag
    event.add('forge:raw_duck',
        'duckling:raw_duck'
    )

    // Cart Tags'
    event.add('forge:carts',
