function removeByPattern(event, basePatterns, replacements) {
  for (const basePattern of basePatterns) {
    for (const replacement of replacements) {
      event.remove({ output: basePattern.replace("$$", replacement) });
    }
  }
}
...
ServerEvents.recipes((event) => {
  const toRemove = [
    ...
    { output: "extradisks:infinite_storage_part" },
    { output: "extradisks:infinite_storage_disk" },
    ...
    { output: "extradisks:advanced_machine_casing" },
  ...
  removeByPattern(
    event,
    [
      "refinedstorage:$$_controller",
      "refinedstorage:$$_fluid_grid",
